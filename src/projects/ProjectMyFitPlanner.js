...
const projectInfo = [
    {
        ...
        overview: 'MyFitPlanner was built with React Native and Firebase for a collaborative group project at BCIT’s Computer Information Technology program. MyFitPlanner is a fitness mobile application that lets you plan out and keep track of your workouts.  After completion, the MyFitPlanner is now available on Google Play.',
        ...
        codeDesc: 'One of the components I developed is the List Item where it fetched and rendered their workout logs from Firebase.',
